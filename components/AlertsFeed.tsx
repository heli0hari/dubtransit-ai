...
import { getServiceAlerts } from '../services/firebase';
import { ServiceAlert } from '../types';
import { AlertTriangle, RefreshCw, AlertOctagon, CloudRain, Calendar, Info, ShieldAlert } from 'lucide-react';
...
export const AlertsFeed: React.FC = () => {
  ...
  const fetchAlerts = async () => {
    setLoading(true);
    const newAlerts = await getServiceAlerts();
    setAlerts(newAlerts);
    setLoading(false);
  };
